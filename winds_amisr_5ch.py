...
def main():
    ...
    outPath= outPath+"/online/"+"2024235"
    ...
    #opObj52.addParameter(name='metadataList', value='type,inputUnit,heightList,paramInterval', format='list')
    ...
    opObj54.addParameter(name='zlimits', value='(-25,25),(-25,25),(-20,20)')# se esta consideranddo cuarta y tercera parte
    opObj54.addParameter(name='cb_labels', value='m/s,m/s,cm/s')
    opObj54.addParameter(name='throttle', value='1')
    opObj54.addParameter(name='xmin', value=1)
    opObj54.addParameter(name='xmax', value=18)
    opObj54.addParameter(name='ymin', value='0', format='int')
    opObj54.addParameter(name='ymax', value='10', format='int')
    '''
